/**
 * File SlidingTabStrip
 * Project Pingo
 * Created by Pingo Team
 * (c) Pingo tn
 * Used to defines striped tabs
 */
...
class SlidingTabStrip extends LinearLayout {
    ...
    private TabLayout.TabColorizer customTabColorizer;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final TabLayout.TabColorizer tabColorizer = customTabColorizer != null
                ? customTabColorizer
                : defaultTabColorizer;
