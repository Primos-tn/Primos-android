...
public abstract class EndlessPagerViewSwipeListener extends ViewPager.SimpleOnPageChangeListener {
    ...
    public EndlessPagerViewSwipeListener(ViewPager viewPager){
